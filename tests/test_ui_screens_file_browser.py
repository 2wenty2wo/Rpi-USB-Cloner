...
class TestGetAvailableLocations:
    ...
    def test_no_locations(self):
        ...
        with patch("rpi_usb_cloner.ui.screens.file_browser._get_usb_mountpoints", return_value=[]):
            with patch("rpi_usb_cloner.ui.screens.file_browser.find_image_repos", return_value=[]):
    ...
    def test_usb_locations_only(self):
        ...
        with patch("rpi_usb_cloner.ui.screens.file_browser._get_usb_mountpoints", return_value=usb_mounts):
            with patch("rpi_usb_cloner.ui.screens.file_browser.find_image_repos", return_value=[]):
                locations = _get_available_locations()
    ...
    def test_repo_locations_only(self):
        ...
        with patch("rpi_usb_cloner.ui.screens.file_browser._get_usb_mountpoints", return_value=[]):
            with patch("rpi_usb_cloner.ui.screens.file_browser.find_image_repos", return_value=repos):
                locations = _get_available_locations()
...
class TestShowFileBrowser:
    ...
    def test_no_drives_available(self):
        ...
        with patch("rpi_usb_cloner.ui.screens.file_browser._get_available_locations", return_value=[]):
            with patch("rpi_usb_cloner.ui.screens.file_browser.display") as mock_display:
                with patch("rpi_usb_cloner.ui.screens.file_browser.time"):
    ...
    def test_browser_exit_on_a(self):
        ...
        with patch("rpi_usb_cloner.ui.screens.file_browser._get_available_locations") as mock_locs:
            with patch("rpi_usb_cloner.ui.screens.file_browser._render_browser_screen"):
                with patch("rpi_usb_cloner.ui.screens.file_browser.menus"):
                    with patch("rpi_usb_cloner.ui.screens.file_browser.gpio") as mock_gpio:
                        ...
                        mock_gpio.is_pressed.side_effect = [
                            ...
                            True, False, False, False, False, False,  # A pressed (exit)
                        ]
    ...
    def test_browser_navigate_up_down(self):
        ...
        with patch("rpi_usb_cloner.ui.screens.file_browser._get_available_locations") as mock_locs:
            with patch("rpi_usb_cloner.ui.screens.file_browser._render_browser_screen") as mock_render:
                with patch("rpi_usb_cloner.ui.screens.file_browser.menus"):
                    with patch("rpi_usb_cloner.ui.screens.file_browser.gpio") as mock_gpio:
