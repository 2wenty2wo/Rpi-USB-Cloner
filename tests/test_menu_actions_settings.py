...
class TestRunOperation:
    ...
    def test_run_operation_sets_flags(self):
        ...
        with patch(
            "rpi_usb_cloner.menu.actions.settings.get_action_context",
...
class TestSettingsActions:
    ...
    def test_settings_coming_soon(self, mock_context):
        ...
        with patch(
            "rpi_usb_cloner.menu.actions.settings.settings_actions"
        ) as mock_actions:
    ...
    def test_update_version(self, mock_context):
        ...
        with patch("rpi_usb_cloner.menu.actions.settings.settings_actions"), patch(
            "rpi_usb_cloner.menu.actions.settings._run_operation"
        ) as mock_run:
