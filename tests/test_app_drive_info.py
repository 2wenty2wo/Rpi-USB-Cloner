...
class TestRenderDriveInfo:
    ...
    def test_drive_found_renders_info_screen(self):
        ...
        devices = [
            {"name": "sda", "size": 16106127360, "vendor": "Kingston", "model": "DataTraveler"},
        ]
        ...
        info_lines = call_args[0][1] if call_args[0] else call_args.kwargs.get("info_lines")
