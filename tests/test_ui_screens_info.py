...
class TestWaitForPaginatedInput:
    ...
    def test_wait_for_paginated_button_a(self):
        ...
        with patch("rpi_usb_cloner.ui.screens.info.display") as mock_display, patch(
            "rpi_usb_cloner.ui.screens.info.menus"
        ), patch("rpi_usb_cloner.ui.screens.info.gpio") as mock_gpio:
            mock_gpio.PIN_A = 1
            mock_gpio.PIN_B = 2
            mock_gpio.PIN_L = 3
            mock_gpio.PIN_R = 4
...
class TestWaitForScrollableKeyValueInput:
    ...
    def test_scrollable_kv_with_transition(self):
        ...
        with patch("rpi_usb_cloner.ui.screens.info.display") as mock_display, patch(
            "rpi_usb_cloner.ui.screens.info.menus"
        ), patch("rpi_usb_cloner.ui.screens.info.gpio") as mock_gpio, patch(
            "rpi_usb_cloner.ui.screens.info.transitions"
        ):
            mock_gpio.PIN_A = 1
            mock_gpio.is_pressed.return_value = False
            mock_gpio.is_pressed.side_effect = [
            ...
            mock_display.get_display_context.return_value = mock_context
            mock_display.render_scrollable_key_value_lines.return_value = (10, 0)
            mock_display.render_scrollable_key_value_lines_image.return_value = (
                MagicMock(),
                20,
                0,
            )
